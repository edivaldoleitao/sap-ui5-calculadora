		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calculadora",
									"targetURL": "#sapcalculadoraproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcalculadoraproject1-display": {
								"semanticObject": "sapcalculadoraproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.calculadora.project1",
									"url": sap.ui.require.toUrl("sap/calculadora/project1")
								}
							}
						}
					}
